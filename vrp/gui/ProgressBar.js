  ...
  if(anchor){
    ...
    if(anchor_index >= 0){
      if(anchor_name == "minimap"){ //MINIMAP
        var width = config.anchor_minimap_width/anchor.length; //divide horizontal map space by number of pbars
...
if ($(window).width() >= 1900 ) {
        ...
        //set position
        this.div.style.left = (config.anchor_minimap_left+anchor_index*136-31)+"px";
        this.div.style.top = (document.body.offsetHeight-config.anchor_minimap_bottom+197)+"px";
      }
        ...
        //set position
        this.div.style.left = (config.anchor_minimap_left+anchor_index*114-37)+"px";
        this.div.style.top = (document.body.offsetHeight-config.anchor_minimap_bottom+199)+"px";
      }
        ...
        //set position
        this.div.style.left = (config.anchor_minimap_left+anchor_index*97-39)+"px";
        this.div.style.top = (document.body.offsetHeight-config.anchor_minimap_bottom+202)+"px";
      }
        ...
        //set position
        this.div.style.left = (config.anchor_minimap_left+anchor_index*91-40)+"px";
        this.div.style.top = (document.body.offsetHeight-config.anchor_minimap_bottom+202)+"px";
      }
else {
        //set size
        ...
        //set position
        this.div.style.left = (config.anchor_minimap_left+anchor_index*97-45)+"px";
        this.div.style.top = (document.body.offsetHeight-config.anchor_minimap_bottom+202)+"px";
      }
}
