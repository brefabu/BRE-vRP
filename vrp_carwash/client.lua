...
Citizen.CreateThread(function ()
	while true do
		...
		if IsPedSittingInAnyVehicle(GetPlayerPed(-1)) then 
			for i,v in pairs(vehicleWashStation) do
				DrawMarker(1, v[1], v[2], v[3], 0, 0, 0, 0, 0, 0, 5.0, 5.0, 2.0, 0, 157, 0, 155, 0, 0, 2, 0, 0, 0, 0)
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), v[1], v[2], v[3], true ) < 5 then
					DrawSpecialText("Apasa [~g~ENTER~s~] pentru a spala vehiculul!")
