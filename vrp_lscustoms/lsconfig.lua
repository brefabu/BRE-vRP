...
local colors = {
	...
	------Neon layout------
		...
		--Neon color
		neoncolor = {
			{ name = "White", neon = {255,255,255}, price = 5000},
			{ name = "Blue", neon = {0,0,255}, price = 8000},
			{ name = "Electric Blue", neon = {0,150,255}, price = 8000},
			{ name = "Mint Green", neon = {50,255,155}, price = 8000},
			{ name = "Lime Green", neon = {0,255,0}, price = 8000},
			{ name = "Yellow", neon = {255,255,0}, price = 8000},
			{ name = "Golden Shower", neon = {204,204,0}, price = 8000},
			{ name = "Orange", neon = {255,128,0}, price = 8000},
			{ name = "Red", neon = {255,0,0}, price = 8000},
			{ name = "Pony Pink", neon = {255,102,255}, price = 8000},
			{ name = "Hot Pink",neon = {255,0,255}, price = 8000},
			{ name = "Purple", neon = {153,0,153}, price = 8000},
			{ name = "Brown", neon = {139,69,19}, price = 8000},
		},
	...
	----Wheel accessories----
		wheelaccessories = {
			...
			{ name = "White Tire Smoke",smokecolor = {254,254,254}, price = 5000},
			{ name = "Black Tire Smoke", smokecolor = {1,1,1}, price = 5000},
			{ name = "BLue Tire Smoke", smokecolor = {0,150,255}, price = 5000},
			{ name = "Yellow Tire Smoke", smokecolor = {255,255,50}, price = 5000},
			{ name = "Orange Tire Smoke", smokecolor = {255,153,51}, price = 5000},
			{ name = "Red Tire Smoke", smokecolor = {255,10,10}, price = 5000},
			{ name = "Green Tire Smoke", smokecolor = {10,255,10}, price = 5000},
			{ name = "Purple Tire Smoke", smokecolor = {153,10,153}, price = 5000},
			{ name = "Pink Tire Smoke", smokecolor = {255,102,178}, price = 5000},
			{ name = "Gray Tire Smoke",smokecolor = {128,128,128}, price = 5000},
		},
	...
	----Sport wheels-----
		sportwheels = {
			{name = "Stock", wtype = 0, mod = -1, price = 7000},
			{name = "Inferno", wtype = 0, mod = 0, price = 6000},
			{name = "Deepfive", wtype = 0, mod = 1, price = 6000},
			{name = "Lozspeed", wtype = 0, mod = 2, price = 8000},
			{name = "Diamondcut", wtype = 0, mod = 3, price = 9000},
			{name = "Chrono", wtype = 0, mod = 4, price = 6000},
			{name = "Feroccirr", wtype = 0, mod = 5, price = 6000},
			{name = "Fiftynine", wtype = 0, mod = 6, price = 7000},
			{name = "Mercie", wtype = 0, mod = 7, price = 5500},
			{name = "Syntheticz", wtype = 0, mod = 8, price = 8000},
			{name = "Organictyped", wtype = 0, mod = 9, price = 9000},
			{name = "Endov1", wtype = 0, mod = 10, price = 7000},
			{name = "Duper7", wtype = 0, mod = 11, price = 6000},
			{name = "Uzer", wtype = 0, mod = 12, price = 6000},
			{name = "Groundride", wtype = 0, mod = 13, price = 9000},
			{name = "Spacer", wtype = 0, mod = 14, price = 8000},
			{name = "Venum", wtype = 0, mod = 15, price = 7000},
			{name = "Cosmo", wtype = 0, mod = 16, price = 6000},
			{name = "Dashvip", wtype = 0, mod = 17, price = 5000},
			{name = "Icekid", wtype = 0, mod = 18, price = 8000},
			{name = "Ruffeld", wtype = 0, mod = 19, price = 7000},
			{name = "Wangenmaster", wtype = 0, mod = 20, price = 9000},
			{name = "Superfive", wtype = 0, mod = 21, price = 8000},
			{name = "Endov2", wtype = 0, mod = 22, price = 7000},
			{name = "Slitsix", wtype = 0, mod = 23, price = 6000},
		},
	-----Suv wheels------
		suvwheels = {
			{name = "Stock", wtype = 3, mod = -1, price = 5000},
			{name = "Vip", wtype = 3, mod = 0, price = 5000},
			{name = "Benefactor", wtype = 3, mod = 1, price = 5000},
			{name = "Cosmo", wtype = 3, mod = 2, price = 5000},
			{name = "Bippu", wtype = 3, mod = 3, price = 5000},
			{name = "Royalsix", wtype = 3, mod = 4, price = 5000},
			{name = "Fagorme", wtype = 3, mod = 5, price = 5000},
			{name = "Deluxe", wtype = 3, mod = 6, price = 5000},
			{name = "Icedout", wtype = 3, mod = 7, price = 5000},
			{name = "Cognscenti", wtype = 3, mod = 8, price = 5000},
			{name = "Lozspeedten", wtype = 3, mod = 9, price = 5000},
			{name = "Supernova", wtype = 3, mod = 10, price = 5000},
			{name = "Obeyrs", wtype = 3, mod = 11, price = 5000},
			{name = "Lozspeedballer", wtype = 3, mod = 12, price = 5000},
			{name = "Extra vaganzo", wtype = 3, mod = 13, price = 5000},
			{name = "Splitsix", wtype = 3, mod = 14, price = 5000},
			{name = "Empowered", wtype = 3, mod = 15, price = 5000},
			{name = "Sunrise", wtype = 3, mod = 16, price = 5000},
			{name = "Dashvip", wtype = 3, mod = 17, price = 5000},
			{name = "Cutter", wtype = 3, mod = 18, price = 5000},
		},
	-----Offroad wheels-----
		offroadwheels = {
			{name = "Stock", wtype = 4, mod = -1, price = 8000},
			{name = "Raider", wtype = 4, mod = 0, price = 7000},
			{name = "Mudslinger", wtype = 4, modtype = 23, wtype = 4, mod = 1, price = 7000},
			{name = "Nevis", wtype = 4, mod = 2, price = 7000},
			{name = "Cairngorm", wtype = 4, mod = 3, price = 7000},
			{name = "Amazon", wtype = 4, mod = 4, price = 7000},
			{name = "Challenger", wtype = 4, mod = 5, price = 7000},
			{name = "Dunebasher", wtype = 4, mod = 6, price = 7000},
			{name = "Fivestar", wtype = 4, mod = 7, price = 7000},
			{name = "Rockcrawler", wtype = 4, mod = 8, price = 7000},
			{name = "Milspecsteelie", wtype = 4, mod = 9, price = 7000},
		},
	-----Tuner wheels------
		tunerwheels = {
			{name = "Stock", wtype = 5, mod = -1, price = 6000},
			{name = "Cosmo", wtype = 5, mod = 0, price = 6000},
			{name = "Supermesh", wtype = 5, mod = 1, price = 6000},
			{name = "Outsider", wtype = 5, mod = 2, price = 6000},
			{name = "Rollas", wtype = 5, mod = 3, price = 6000},
			{name = "Driffmeister", wtype = 5, mod = 4, price = 6000},
			{name = "Slicer", wtype = 5, mod = 5, price = 6000},
			{name = "Elquatro", wtype = 5, mod = 6, price = 6000},
			{name = "Dubbed", wtype = 5, mod = 7, price = 6000},
			{name = "Fivestar", wtype = 5, mod = 8, price = 6000},
			{name = "Slideways", wtype = 5, mod = 9, price = 6000},
			{name = "Apex", wtype = 5, mod = 10, price = 6000},
			{name = "Stancedeg", wtype = 5, mod = 11, price = 6000},
			{name = "Countersteer", wtype = 5, mod = 12, price = 6000},
			{name = "Endov1", wtype = 5, mod = 13, price = 6000},
			{name = "Endov2dish", wtype = 5, mod = 14, price = 6000},
			{name = "Guppez", wtype = 5, mod = 15, price = 6000},
			{name = "Chokadori", wtype = 5, mod = 16, price = 6000},
			{name = "Chicane", wtype = 5, mod = 17, price = 6000},
			{name = "Saisoku", wtype = 5, mod = 18, price = 6000},
			{name = "Dishedeight", wtype = 5, mod = 19, price = 6000},
			{name = "Fujiwara", wtype = 5, mod = 20, price = 6000},
			{name = "Zokusha", wtype = 5, mod = 21, price = 6000},
			{name = "Battlevill", wtype = 5, mod = 22, price = 6000},
			{name = "Rallymaster", wtype = 5, mod = 23, price = 6000},
		},
	-----Highend wheels------
		highendwheels = {
			{name = "Stock", wtype = 7, mod = -1, price = 10000},
			{name = "Shadow", wtype = 7, mod = 0, price = 10000},
			{name = "Hyper", wtype = 7, mod = 1, price = 10000},
			{name = "Blade", wtype = 7, mod = 2, price = 10000},
			{name = "Diamond", wtype = 7, mod = 3, price = 10000},
			{name = "Supagee", wtype = 7, mod = 4, price = 10000},
			{name = "Chromaticz", wtype = 7, mod = 5, price = 10000},
			{name = "Merciechlip", wtype = 7, mod = 6, price = 10000},
			{name = "Obeyrs", wtype = 7, mod = 7, price = 10000},
			{name = "Gtchrome", wtype = 7, mod = 8, price = 10000},
			{name = "Cheetahr", wtype = 7, mod = 9, price = 10000},
			{name = "Solar", wtype = 7, mod = 10, price = 10000},
			{name = "Splitten", wtype = 7, mod = 11, price = 10000},
			{name = "Dashvip", wtype = 7, mod = 12, price = 10000},
			{name = "Lozspeedten", wtype = 7, mod = 13, price = 10000},
			{name = "Carboninferno", wtype = 7, mod = 14, price = 10000},
			{name = "Carbonshadow", wtype = 7, mod = 15, price = 10000},
			{name = "Carbonz", wtype = 7, mod = 16, price = 10000},
			{name = "Carbonsolar", wtype = 7, mod = 17, price = 10000},
			{name = "Carboncheetahr", wtype = 7, mod = 18, price = 10000},
			{name = "Carbonsracer", wtype = 7, mod = 19, price = 10000},
		},
	-----Lowrider wheels------
		lowriderwheels = {
			{name = "Stock", wtype = 2, mod = -1, price = 8000},
			{name = "Flare", wtype = 2, mod = 0, price = 8000},
			{name = "Wired", wtype = 2, mod = 1, price = 8000},
			{name = "Triplegolds", wtype = 2, mod = 2, price = 8000},
			{name = "Bigworm", wtype = 2, mod = 3, price = 8000},
			{name = "Sevenfives", wtype = 2, mod = 4, price = 8000},
			{name = "Splitsix", wtype = 2, mod = 5, price = 8000},
			{name = "Freshmesh", wtype = 2, mod = 6, price = 8000},
			{name = "Leadsled", wtype = 2, mod = 7, price = 8000},
			{name = "Turbine", wtype = 2, mod = 8, price = 8000},
			{name = "Superfin", wtype = 2, mod = 9, price = 8000},
			{name = "Classicrod", wtype = 2, mod = 10, price = 8000},
			{name = "Dollar", wtype = 2, mod = 11, price = 8000},
			{name = "Dukes", wtype = 2, mod = 12, price = 8000},
			{name = "Lowfive", wtype = 2, mod = 13, price = 8000},
			{name = "Gooch", wtype = 2, mod = 14, price = 8000},
		},
	-----Muscle wheels-----
		musclewheels = {
			{name = "Stock", wtype = 1, mod = -1, price = 10000},
			{name = "Classicfive", wtype = 1, mod = 0, price = 10000},
			{name = "Dukes", wtype = 1, mod = 1, price = 10000},
			{name = "Musclefreak", wtype = 1, mod = 2, price = 10000},
			{name = "Kracka", wtype = 1, mod = 3, price = 10000},
			{name = "Azrea", wtype = 1, mod = 4, price = 10000},
			{name = "Mecha", wtype = 1, mod = 5, price = 10000},
			{name = "Blacktop", wtype = 1, mod = 6, price = 10000},
			{name = "Dragspl", wtype = 1, mod = 7, price = 10000},
			{name = "Revolver", wtype = 1, mod = 8, price = 10000},
			{name = "Classicrod", wtype = 1, mod = 9, price = 10000},
			{name = "Spooner", wtype = 1, mod = 10, price = 10000},
			{name = "Fivestar", wtype = 1, mod = 11, price = 10000},
			{name = "Oldschool", wtype = 1, mod = 12, price = 10000},
			{name = "Eljefe", wtype = 1, mod = 13, price = 10000},
			{name = "Dodman", wtype = 1, mod = 14, price = 10000},
			{name = "Sixgun", wtype = 1, mod = 15, price = 10000},
			{name = "Mercenary", wtype = 1, mod = 16, price = 10000},
		},
	...
	-----------Armor-------------
		[16] = {
			...
			{name = "Armor Upgrade 40%",modtype = 16, mod = 1, price = 15000},
			{name = "Armor Upgrade 60%",modtype = 16, mod = 2, price = 17500},
			{name = "Armor Upgrade 80%",modtype = 16, mod = 3, price = 25000},
			{name = "Armor Upgrade 100%",modtype = 16, mod = 4, price = 35000},
		},
	...
	-----------Horn----------
		[14] = {
			...
			{name = "Police Horn", mod = 1, price = 200},
			{name = "Clown Horn", mod = 2, price = 200},
	...
	----------Transmission---------
		[13] = {
			...
			{name = "Sports Transmission", mod = 1, price = 11000},
	...
	-----------Brakes-------------
		[12] = {
			...
			{name = "Race Brakes", mod = 2, price = 9000},
		},
		
	------------Engine----------
		[11] = {
			{name = "EMS Upgrade, Level 2", mod = 0, price = 7000},
			{name = "EMS Upgrade, Level 3", mod = 1, price = 15000},
			{name = "EMS Upgrade, Level 4", mod = 2, price = 25000},
		},
