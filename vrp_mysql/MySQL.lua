...
local modules = {}
function loadModule(rsc, path) -- load a LUA resource file as module
...
local MySQLSync = loadModule("mysql-async", "lib/MySQL")
...
--  print("[vRP] try to create connection "..name)
  ...
  local config = "server="..host..";uid="..user..";pwd="..password..";database="..db..";Allow User Variables=true"
